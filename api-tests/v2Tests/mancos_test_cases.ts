  ...
  it("should return point data for Detroit", function (done) {
    request(settings.host)
      ...
      .expect(function (res: { body: { success: { data: { uid: number; rocktype: string | any[]; age: string; name: string | any[]; desc: string | any[]; comm: string | any[]; strat_unit: string | any[]; col_id: number; }; }; }; }) {
  ...
  it("should return point details for Detroit", function (done) {
    request(settings.host)
      ...
      .expect(function (res: { body: { success: { data: { column: { units: string | any[]; }; }[]; }; }; }) {
        if (
  ...
  it("should return point data for Toronto", function (done) {
    request(settings.host)
      ...
      .expect(validators.aSuccessfulRequest)
      .expect(validators.json)
      .expect(function (res: { body: { success: { data: { uid: number; rocktype: string | any[]; age: string; name: string | any[]; strat_unit: string | any[]; desc: string | any[]; comm: string | any[]; col_id: number; }; }; }; }) {
  ...
  it("should return point data for Buenos Aires", function (done) {
    request(settings.host)
      ...
      .expect(validators.aSuccessfulRequest)
      .expect(validators.json)
      .expect(function (res: { body: { success: { data: { uid: string | any[]; rocktype: string | any[]; age: string | any[]; name: string | any[]; strat_unit: string | any[]; desc: string | any[]; comm: string | any[]; col_id: string | any[]; }; }; }; }) {
