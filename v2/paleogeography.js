  ...
  if (!req.query.age && !req.query.interval_name && !("sample" in req.query)) {
    ...
    async.waterfall([
      ...
      function(year, callback) {
        ...
        larkin.queryPg("alice", "SELECT plateid1::integer AS plate_id, ST_AsGeoJSON(geom) AS geometry FROM earthbyte2013_raw.reconstructed_" + year + limit, [], function(error, result) {
