...
module.exports = function(req, res, next, cb) {
  ...
  if (req.query.mineral_id) {
    ...
    var parsedElements = larkin.parseMultipleStrings(req.query.element).join('|');
    params = {
    ...
    sql += " WHERE formula REGEXP BINARY :elementA OR formula REGEXP BINARY :elementB OR formula REGEXP BINARY :elementC OR formula REGEXP BINARY :elementD ORDER BY mineral";
