module.exports = function () {
  ...
  it("should accept a shape", function (done) {
    ...
    request(settings.host)
      .get(
        "/api/v2/carto/small?shape=POLYGON((-95.44921875 41.3355759731239,-95.44921875 43.0929606771163,-92.79052734375 43.0929606771163,-92.79052734375 41.3355759731239,-95.44921875 41.3355759731239))",
      )
      .expect(validators.aSuccessfulRequest)
      .expect(validators.json)
      .expect(validators.atLeastOneResult)
