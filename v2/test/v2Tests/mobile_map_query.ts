module.exports = function() {
  ...
  it('should accept a latitude, longitude, and z', function(done) {
    request(settings.host)
      .get('/api/v2/mobile/map_query?lat=43.0706192&lng=-89.406167&z=8')
      .expect(validators.aSuccessfulRequest)
      .expect(validators.json)
  ...
  it('should require a lat, lng, and z', function(done) {
    request(settings.host)
      .get('/api/v2/mobile/map_query?lat=1&lng=1')
      .expect(validators.json)
      .expect(function(res) {
      //  var response = res.body.success.data
  ...
  it('should not choke on a fractional zoom', function(done) {
    request(settings.host)
      .get('/api/v2/mobile/map_query?lat=43.0706192&lng=-89.406167&z=8.984324234')
      .expect(validators.aSuccessfulRequest)
      .expect(validators.json)
      .expect(validators.atLeastOneResult)
      .expect(function(res) {
