  ...
  larkin.sendData(
    ...
    },
    {
      data: {
        ...
        api: ["John J Czaplewski", "Puneet Kishor", "Shanan E Peters"],
      },
      support: {
        current_funding:
          "U.S. National Science Foundation Grant EAR-1150082 and ICER-1440312. Additional support from the University of Wisconsin-Madison Dept. of Geoscience.",
        previous_funding:
          "Initial database development supported by the United States Geological Survey and the American Chemical Society.",
      },
      acknowledgements: {
        data_entry:
          "University of Michigan Undergraduate Research Opportunity program, Noel Heim, Deb Rook, Neal Auchter, Annaka Clement, Clay Kelly.",
