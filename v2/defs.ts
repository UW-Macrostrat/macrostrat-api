  ...
  var defs = {
    ...
    "/sections": {
      ...
      options: {
        ...
        response_types: ["short", "long"],
        examples: ["/api/sections?all", "/api/sections?col_id=49"],
        fields: [
          "col_id",
          "col_area",
          "section_id",
    ...
    "/fossils": {
      description:
        "Paleobiology Database (http://paleobiodb.org) collections matched to Macrostrat units",
      visible: true,
      options: {
        parameters: {
          interval_name: "string, chronostratigraphic time interval name",
          ...
          strat_name_id:
            "One or more comma-separted valid strat_name_ids from /defs/strat_names",
          strat_name_concept_id:
            "One or more stratigraphic name concepts from /defs/strat_name_concepts",
    ...
    "/defs/lithologies": {
      ...
      options: {
        ...
        fields: ["lith_id", "name", "group", "type", "class", "color"],
      },
    },
    ...
    "/defs/structures": {
      ...
      options: {
        ...
        fields: ["structure_id", "name", "group", "type", "class"],
      },
    },
    "/defs/columns": {
    ...
    "/defs/econs": {
      ...
      options: {
        ...
        fields: ["econ_id", "name", "type", "class", "color"],
      },
    },
    "/defs/environments": {
      ...
      options: {
        ...
        fields: ["environ_id", "name", "type", "class", "color"],
      },
    },
    "/defs/intervals": {
      ...
      options: {
        parameters: {
          ...
          timescale:
            "string, a valid timescale name as defined in /api/v2/defs/timescales",
          timescale_id:
            "integer, a valid timescale_id as defined in /api/v2/defs/timescales",
          format: "Desired output format",
        },
        output_formats: ["json", "csv"],
        examples: [
    ...
    "/defs/sources": {
      ...
      options: {
        parameters: {
          ...
          scale:
            "string, one or more comma-separated Burwell scales (tiny, small, medium, large)",
          lat: "A valid latitude",
          lng: "A valid longitude",
          shape: "string, a WKT geometry that can be used to filter sources",
          buffer:
            "integer, buffer in meters that should be applied to a provided shape",
    ...
    "/defs/strat_names": {
      ...
      options: {
        parameters: {
          ...
          strat_name_like:
            "lithostratigraphic name, with open-ended string matching",
          ...
          interval_name:
            "chronostratigrpahic interval name (see /defs/intervals); this will return only strat_names with a declared age in Macrostrat",
          ref_id:
    ...
    "/defs/timescales": {
      ...
      options: {
        ...
        output_formats: ["json", "csv"],
        examples: ["api/v2/defs/timescales?all"],
        fields: [
          "timescale_id",
          "timescale",
          "max_age",
    ...
    "/defs/minerals": {
      ...
      options: {
        parameters: {
          ...
          element:
            "string, chemical element abbreviation, case sensitive (e.g., Co)",
          format: "Desired output format",
        },
        output_formats: ["json", "csv"],
        examples: [
    ...
    "/defs/projects": {
      ...
      options: {
        parameters: {
          ...
          project_id:
            "integer identifying project(s), separate multiple values with commas",
          format: "Desired output format",
        },
        output_formats: ["json", "csv"],
        examples: ["api/v2/defs/projects?all"],
        fields: [
          "project_id",
          "project",
          "decrip",
    ...
    "/defs/measurements": {
      ...
      options: {
        ...
        fields: ["measure_id", "name", "type", "class", "t_units"],
      },
    },
    ...
    "/defs/groups": {
      ...
      options: {
        ...
        output_formats: ["json", "csv"],
        examples: ["api/v2/defs/groups?all"],
        fields: [
          "col_group_id",
          "col_group",
          "t_units",
    ...
    "/defs/grainsizes": {
      ...
      options: {
        parameters: {
          ...
          classification:
            "The classification scheme the given grain belongs to",
    ...
    "/defs/refs": {
      ...
      options: {
        ...
        output_formats: ["json", "csv"],
        examples: ["api/v2/defs/groups?all"],
        fields: ["ref_id", "pub_year", "author", "ref", "doi", "url"],
      },
    },
    "/defs/drilling_sites": {
      description:
        "Returns metadata for offshore drilling sites from ODP, DSDP and IODP",
      parent: "definitions",
      visible: true,
      options: {
        parameters: {
          epoch:
            "string, drilling 'epoch'; only three valid values. DSDP, ODP and IODP",
          leg: "string, drilling leg (or expedition for IODP)",
          site: "string, drilling site",
          col_id: "integer, one or more Macrostrat column ids",
          col_group_id:
            "integer, one or more Macrostrat column group ids; corresponds to legs/expeditions",
          all: "return all drilling expeditions and sites",
          sample: "if present, get a selection of data",
          format:
            "desired output format, options given below in output_formats",
        },
        output_formats: [
          "json",
          "csv",
    ...
    "/section_stats": {
      ...
      options: {
        ...
        output_formats: ["json", "csv"],
        examples: ["api/section_stats?all", "api/section_stats?all&format=csv"],
        fields: [
          "project",
          "col_id",
          "section_id",
    ...
    "/measurements": {
      ...
      options: {
        parameters: {
          ...
          measuremeta_id:
            "integer, specific id for measurment metadata (generally a sample)",
          unit_id: "integer, one or more ids for unit containing measurements",
          interval_name:
            "string, an interval name to restrict measurements matched to units touching given age",
          ...
          measure_phase:
            "string, phase from which measurement was taken (e.g., 'zircon')",
          response:
            "Any available response_type. Default is short. Use 'light' for effecient return of measurements with little metadata",
          format: "Desired output format",
          sample: "if present, show a subset of the data",
          show_values:
            "if present, show measurements as arrays, grouped by measuremeta_id and measurement_id",
        },
        response_types: ["light", "short", "long"],
        output_formats: [
          "json",
          "csv",
          "geojson",
    ...
    "/eodp": {
      ...
      options: {
        parameters: {
          epoch:
            "string, drilling 'epoch'; only three valid values (DSDP, ODP and IODP), but note that Baggage Stipper limited to IODP",
    ...
    "/geologic_units/gmna": {
      description:
        "Geologic map units. Continental-scale North American map data (gmna) adapted from the 2005 Geologic Map of North America (http://ngmdb.usgs.gov/gmna/)",
      visible: false,
      ...
      options: {
        parameters: {
          ...
          interval_name:
            "string, a valid interval name as defined in /defs/intervals",
    ...
    "/geologic_units/gmus": {
      description:
        "Geologic map units. State-level (gmus) data adapated from http://mrdata.usgs.gov/geology/state/.",
      visible: false,
      parent: "geologic_units",
      options: {
        parameters: {
          ...
          strat_name_id:
            "integer, one or more valid strat_name_ids from /defs/strat_names",
    ...
    "/geologic_units/burwell": {
      ...
      options: {
        ...
        examples: ["/api/v2/geologic_units/burwell?lat=43&lng=-89.3"],
        fields: [
          "map_id",
          "source_id",
          "name",
    ...
    "/geologic_units/burwell/points": {
      ...
      options: {
        parameters: {
          ...
          minlat:
            "A minimum latitude that represents the southwest corner of a bounding box (requires minlng, maxlat, and maxlng)",
          minlng:
            "A minimum longitude that represents the southwest corner of a bounding box (requires minlat, maxlat, and maxlng)",
          maxlat:
            "A maximum latitude that represents the northeast corner of a bounding box (requires minlat, minlng, and maxlng)",
          maxlng:
            "A maximum longitude that represents the northeast corner of a bounding box (requires minlat, minlng, and maxlat)",
    ...
    "/geologic_units/map/legend": {
      ...
      options: {
        parameters: {
          scale:
            "Restrict results to maps of a specific scale(s) in Macrostrat's system, can be tiny, small, medium, or large",
          carto:
            "Restrict results to map components present in one of Macrostrat's map harmonized scales: tiny, small, medium, large",
          source_id:
            "Integer(s), one or more comma-separated integers identifying map sources",
          ...
          lith_id:
            "Integer(s), one or more comma-separated integers identifying specific lithologies",
    ...
    "/geologic_units/burwell/nearby": {
      description:
        "Stratigraphic names, lithologies, and time intervals near a coordinate in Burwell",
      visible: false,
      parent: "geologic_units",
      options: {
        parameters: {
    ...
    "/geologic_units/map/nearby": {
      description:
        "Stratigraphic names, lithologies, and time intervals near a coordinate in Macrostrat",
      visible: false,
      parent: "geologic_units",
      options: {
        parameters: {
    ...
    "/elevation": {
      description:
        "Returns elevation in meters at a given coordinate from ETOPO1 and SRTM1",
      visible: false,
      options: {
        parameters: {
          lat: "A valid latitude",
        ...
        output_formats: ["json", "csv"],
        examples: ["api/elevation?lat=43&lng=-89"],
        fields: ["elevation"],
      },
    },
    "/infer": {
    ...
    "/grids/longitude": {
      description:
        "Returns a grid given a latitude spacing and target cell size",
      parent: "grids",
      visible: true,
      options: {
        parameters: {
    ...
    "/grids/lithologies": {
      description:
        "Returns a grid given a latitude and longitude spacing with burwell lithology info",
      parent: "grids",
      visible: true,
      options: {
        parameters: {
    ...
    "/places": {
      ...
      options: {
        parameters: {
          ...
          placetype:
            "text, the type of the place (continent, country, region, county, or locality)",
          childtype:
            "text, if provided, returns the specified childtype of the provided wof_id or name",
          format: "Desired output format",
        },
        output_formats: [
          "json",
    ...
    "/age_model": {
      description:
        "Get all components of column age models; mostly unit_boundaries but can include other constraints",
      visible: true,
      options: {
        parameters: {
        ...
        output_formats: ["json", "csv"],
        examples: ["/age_models?section_id=1"],
        fields: [
          "boundary_id",
          "col_id",
          "section_id",
    ...
    "/mobile/point": {
      description:
        "Get the largest scale geological map data available in Macrostrat/burwell for coordinates and relevant Macrostrat col_id (if any)",
      parent: "mobile",
      visible: true,
      options: {
        parameters: {
          ...
          lng: "A valid longitude",
          geo_format:
            "Output geometry format - can be 'wkt' or 'geojson'; Defaults to 'geojson'",
        },
        output_formats: ["json"],
        examples: [
        ...
        fields: ["gid", "unit_name", "col_id", "col_poly"],
      },
    },
    "/mobile/point_details": {
      description:
        "Get state-level geologic map unit description and Macrostrat units for a given location. A valid latitude and longitude or column ID and map unit ID are required.",
      parent: "mobile",
      visible: false,
      options: {
        parameters: {
    ...
    "/mobile/fossil_collections": {
      description:
        "Get Paleobiology Database (http://paleobiodb.org) fossil collection numbers matched to a given Macrostrat unit",
      parent: "mobile",
      visible: true,
      options: {
        parameters: {
        ...
        output_formats: ["json"],
        examples: ["/mobile/fossil_collections?unit_id=6132"],
        fields: ["cltn_id", "cltn_name"],
      },
    },
    ...
    "/mobile/macro_summary": {
      ...
      options: {
        ...
        output_formats: ["json"],
        examples: ["/mobile/macro_summary?lat=43.0706192&lng=-89.406167"],
        fields: [
          "max_thick",
          "min_min_thick",
          "b_age",
    ...
    "/mobile/dashboard": {
      ...
      options: {
        ...
        output_formats: ["json"],
        examples: ["/mobile/dashboard?lat=43.0706192&lng=-89.406167"],
        fields: [
          "max_thick",
          "min_min_thick",
          "b_age",
    ...
    "/mobile/map_query": {
      ...
      options: {
        ...
        output_formats: ["json"],
        examples: ["/mobile/map_query?lat=43.0706192&lng=-89.406167&z=10"],
        fields: [],
      },
    },
    ...
    "/mobile/map_filter": {
      ...
      options: {
        parameters: {
          lith_id:
            "integer, one or more comma-separated lithology ids: matches strictly to lith field in map data",
          lith_type:
            "string, one or more comma-separated lith_types: matches strictly to lith field in map data",
          lith_class:
            "string, one or more comma-separated lith_classes: matches strictly to lith field in map data",
          all_lith_id:
            "integer, one or more comma-separated lithology ids: matches any lith in any legend field",
          all_lith_type:
            "string, one or more comma-separated lith_types: matches any lith_type in any legend field",
          all_lith_class:
            "string, one or more comma-separated lith_classes: matches any lith_type in any legend field",
          strat_name_id: "integer, one or more comma-separated strat_name_ids",
          concept_id:
            "integer, one or more comma-separated strat_name concept_ids ids",
        },
        output_formats: ["json"],
        examples: [],
        fields: [],
    ...
    define: {
      ...
      col_group:
        "text, name of group the column belongs to, generally corresponds to geologic provinces",
      ...
      strat_name_id:
        "integer, unique identifier for known stratigraphic name(s) (see /defs/strat_names)",
      concept_id:
        "intger, unique identifier for the stratigraphic name concept, which groups variant strat_names for same entity",
      strat_name_concept_id:
        "intger, unique identifier for the stratigraphic name concept, which groups variant strat_names for same entity",
      ...
      min_thick:
        "number, minimum unit thickess in meters (NB: some zero values may be equivalent in meaning to NULL)",
      ...
      FO_interval:
        "text, chronostratigraphic interval containing initiation/earliest(oldest) age",
      FO_age: "number, age of FO_interval base in Myr before present",
      b_interval:
        "integer, chronostratigraphic interval containing continuous time age model oldest boundary",
      b_age:
        "number, continuous time age model estimated for initiation, in Myr before present",
      b_prop:
        "decimal, position of continuous time age model bottom boundary, proportional to reference time interval (b_interval)",
      early_age: "number, oldest age, Myr before present",
      LO_interval:
        "text, chronostratigraphic interval containing truncation/latest(youngest) age",
      LO_age: "number, age of FO_interval top in Myr before present",
      t_age:
        "number, continuous time age model estimated for truncation, in Myr before present",
      t_interval:
        "integer, chronostratigraphic interval containing continuous time age model youngest boundary",
      t_prop:
        "decimal, position of continuous time age model top boundary, proportional to reference time interval (t_interval)",
      late_age: "number, youngest age, Myr before present",
      position_bottom:
        "number, estimated position of unit relative to other units in section",
      ...
      measure_n:
        "number, measurements used to compute measure_value, if greater than 1, typically also used in measure_error",
      measure_position:
        "number, position of measurement in column, optionally section or unit; requires context of latter",
      error_units: "text, units used in reported measure_error",
      measure_type:
        "text, descriptor applying to nature of measure_value (e.g., point measurement, mean value for multiple point measurements)",
      measure_phase:
        "text, material analyzed for measure_value (e.g., 'zircon' or 'whole rock')",
      n: "integer, number of observations/measurements",
      measuremeta_id:
        "integer, unique identifier for measuremeta (sample metadata)",
      samp_lith:
        "text, lithological description of sample that produced measure_value",
      samp_lith_id:
        "integer, unique identifier for lithology (see /defs/lithologies) in sample that produced measure_value",
      ...
      match_basis:
        "text, terse descriptor of what served to match measuremeta record to given macrostrat unit, if any",
      samp_age: "text, geological time interval assigned to measurement",
      unit_rel_pos:
        "number, position of measurement within a unit, usually proportional where 1=top, 0=bottom",
      lith_max_thick:
        "number, thickness of specified lithology, based on proportion of unit(s)",
      lith_min_thick:
        "number, thickness of specified lithology, based on proportion of unit(s)",
      ...
      outcrop:
        "text, describes where unit is exposed or not, values are  'outcrop', 'subsurface', or 'both'",
      ...
      status:
        "text, indicates current status of column, values are 'active', 'in process', 'obsolete'",
      geom: "geometry",
      area: "area in square kilometers",
      plateid: "integer, unique GPlates ID",
      with_unit: "unit in contact with unit_id",
      contact:
        "relative position of units, read for unit_id,  'contact' = with_unit",
      unit_abbre: "text, unit abbreviation",
      rocktype: "text, unit rock type",
      min_age:
        "text, the minimum age of the unit, using the International time scale",
      max_age:
        "text, the maximum age of the unit, using the International time scale",
      ...
      bottom:
        "text, named time interval that contains the bottom of the section",
      ...
      t_plat:
        "number, same as clat, but rotated to the t_age. Top age paleo latitude.",
      t_plng:
        "number, same as clng, but rotated to the t_age. Top age paleo longitude.",
      b_plat:
        "number, same as clat, but rotated to the b_age. Bottom age paleo latitude.",
      b_plng:
        "number, same as clng, but rotated to the b_age. Bottom age paleo latitude.",
      ...
      t_int_id:
        "integer, the ID of the chronostratigraphic interval containing the top boundary of the unit",
      t_int_name:
        "text, the name of the chronostratigraphic interval containing the top boundary of the unit",
      t_int_age:
        "float, the top age of the chronostratigraphic interval containing the top boundary of the unit",
      units_above:
        "array of integers, the unit_ids of the units contacting the top of the unit",
      b_int_id:
        "integer, the ID of the chronostratigraphic interval containing the bottom boundary of the unit",
      b_int_name:
        "text, the name of the chronostratigraphic interval containing the bottom boundary of the unit",
      b_int_age:
        "float, the bottom age of the chronostratigraphic interval containing the bottom boundary of the unit",
      units_below:
        "array of integers, the unit_ids of the units contacting the bottom of the unit",
      ...
      strat_names:
        "array of integer, strat_name_ids matched to the polygon or unit_link",
      strat_unit: "text, the stratigraphic unit of the polygon",
      gid: "integer, unique polygon ID of a map unit",
      containing_interval:
        "text, the interval that includes the top and bottom ages of a unit",
      unit_link:
        "text, the ID assigned to a given group of polygons that share common attributes",
      macro_units:
        "array of integers, the unit_ids of Macrostrat units matched to the polygon or unit_link",
      ...
      group_col_id:
        "float, the original column ID assigned to the column (used in the original source)",
      ...
      max_min_thick:
        "integer, the maximum possible minimum thickness in meters",
      min_min_thick:
        "integer, the minimum possible minimum thickness in meters",
      ...
      interval_name:
        "string, a valid interval name as defined in /defs/intervals",
      age_bottom:
        "decimal, age of bottom of entity (interval_name or unit) in Ma",
      age_top: "decimal, age of top of entity (interval_name or unit) in Ma",
      best_age_bottom:
        "decimal, age of bottom of entity (map unit) in Ma; estimate is 'best' because it incorporates multiple age model sources",
      best_age_top:
        "decimal, age of top of entity (map unit) in Ma; estimate is 'best' because it incorporates multiple age model sources",
      map_unit_name:
        "name of map unit in original source, or modified original source",
      legend_id:
        "integer, macrostrat internal identifier for map unit; one or more map_id values are assigned to a legend_id",
      tiny_area: "number, area in km^2 of map polygons in tiny-scale topology",
      small_area:
        "number, area in km^2 of map polygons in small-scale topology",
      medium_area:
        "number, area in km^2 of map polygons in medium-scale topology",
      large_area:
        "number, area in km^2 of map polygons in large-scale topology",
