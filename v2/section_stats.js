...
module.exports = function(req, res, next) {
  ...
  if ("all" in req.query || "sample" in req.query) {
    ...
    WHERE status_code='active' and units.id IN (SELECT distinct unit_id from unit_liths,liths where lith_id=liths.id and lith_class='sedimentary') and FO_age<=541 GROUP BY units_sections.section_id" + limit;
  } else {
